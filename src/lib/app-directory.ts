...
export const APPS: AppEntry[] = [
  ...
  },
  {
    to: "/timer",
    label: "タイマー",
    keywords: "timer pomodoro ポモドーロ 集中",
    icon: Timer,
    group: "学習",
  },
  {
...
export function findApp(path: string): AppEntry | undefined {
  return APPS.filter((a) => path === a.to || path.startsWith(a.to + "/")).sort(

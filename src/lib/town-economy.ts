...
export const POLICY_DEFS: PolicyDef[] = [
  {
    ...
    gdp: 0.92,
    co2: 0.72,
    requires: (s) => s.activeDays30 >= 5,
    requireLabel: "直近30日で5日以上の学習",
  },
  {
    key: "green_subsidy",
    label: "再エネ補助金",
    ...
    gdp: 0.97,
    co2: 0.85,
    requires: (s) => s.minutes30 >= 600,
    requireLabel: "直近30日で600分以上の学習",
  },
  {
    key: "education_first",
    label: "教育立国",
    ...
    gdp: 1.12,
    co2: 1.0,
    requires: (s) => s.avgScore >= 60,
    requireLabel: "採点平均60点以上",
  },
  {
    key: "tech_invest",
    label: "産業技術投資",
    ...
    gdp: 1.18,
    co2: 1.06,
    requires: (s) => s.minutes30 >= 1200,
    requireLabel: "直近30日で1200分以上の学習",
  },
  {
    key: "transit_pass",
    label: "公共交通無償化",
    ...
    gdp: 0.96,
    co2: 0.88,
    requires: (s) => s.streak >= 5,
    requireLabel: "5日以上の連続学習",
  },
  {
    key: "immigration",
    label: "移住促進",
    ...
    gdp: 1.06,
    co2: 1.08,
    requires: (s) => s.subjects >= 3,
    requireLabel: "3教科以上を学習",
  },
  {
    key: "tourism",
    label: "観光立国",
    ...
    gdp: 1.1,
    co2: 1.04,
    requires: (s) => s.goalsDone >= 1,
    requireLabel: "目標を1つ以上達成",
  },
  {
    key: "smart_grid",
    label: "スマートグリッド",
    ...
    gdp: 1.04,
    co2: 0.8,
    requires: (s) => s.avgScore >= 80 && s.minutes30 >= 900,
    requireLabel: "平均80点以上かつ900分以上の学習",
  },
];
  ...
  const happiness = Math.max(
    ...
    Math.min(
      ...
      Math.round(
        40 +
          consistency * 30 +
          Math.min(20, gdp / Math.max(1, population / 1000) / 6) +
          green * 0.15 -
          10,
      ),
    ),

...
import { adminListUsers, adminCreateUser, adminUpdateUser, adminDeleteUser, adminSetRole, adminImpersonate, adminEnsurePokochan } from "@/lib/admin.functions";
...
import { Shield, Trash2, Pencil, LogIn, Plus, Coins, Save } from "lucide-react";
...
export function UserRow({ user, onChange, update, del, setRole, doImpersonate }: any) {

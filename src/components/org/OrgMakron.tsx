        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="text-xs text-muted-foreground">
              組織のカリキュラムを上から順に進めましょう
            </div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-extrabold text-primary">
              {Object.keys(done).length}
              <span className="text-sm">/{packs.length}</span>
            </div>
      ...
      {assignments.length > 0 && (
        <div className="space-y-2">
          ...
          {assignments.map((a) => (
            ...
            >
              <div className="h-10 w-10 rounded-xl bg-orange-500/15 grid place-items-center">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[11px] text-muted-foreground flex items-center gap-1">
                  ...
                  {a.due_at ? `期限 ${new Date(a.due_at).toLocaleString("ja-JP")}` : "期限なし"}
                  {a.required ? " ・必須" : ""}
                </div>
              </div>
            </Link>

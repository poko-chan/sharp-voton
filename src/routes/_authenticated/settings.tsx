...
const CATEGORIES: SettingsCategory[] = [
  ...
  },
  {
    ...
    label: "通知",
    icon: Bell,
    keywords: ["通知", "リマインダー", "お知らせ", "チャット", "ストリーク", "notification"],
  },
  {
    id: "study",
    label: "学習",
  ...
  },
  {
    ...
    label: "プライバシー",
    icon: Shield,
    keywords: ["プライバシー", "公開", "フレンド", "非公開", "privacy"],
  },
  {
    id: "ai",
    label: "AI",
    icon: Sparkles,
    keywords: ["AI", "モデル", "端末内", "webllm", "gemini", "nano", "ダウンロード", "容量"],
  },
  {
    id: "language",
    label: "言語・翻訳",
    icon: Languages,
    keywords: ["言語", "翻訳", "language", "translate", "日本語", "english"],
  },
  {
    id: "accessibility",
    label: "アクセシビリティ",
  ...
  },
  {
    ...
    label: "危険な操作",
    icon: AlertTriangle,
    keywords: ["削除", "退会", "リセット", "ログアウト", "danger", "delete"],
    danger: true,
  },
];
  ...
  return (
    <div className="mx-auto w-full max-w-5xl p-4 sm:p-6 space-y-4">
      <header className="space-y-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            アカウント・表示・通知・学習など、アプリの動作をカスタマイズできます。
          </p>
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-6">
        {!searching && <SettingsNav categories={CATEGORIES} active={active} onSelect={setActive} />}
  ...
  head: () => ({
    meta: [
      { title: "設定｜Study#" },
      {
        name: "description",
        content:
          "アカウント・表示・通知・学習・AI・プライバシーなど、Study# の各種設定を管理します。",
      },

...
export const Route = createFileRoute("/login")({
  head: () => {
    ...
    const description =
      "StudyΩ にログインして、勉強記録・集中タイマー・AI問題生成・AI家庭教師・学習目標管理などの学習サポート機能を使い始めましょう。新規登録もこちらから。";
          ...
          <Card className="w-full p-8 space-y-6">
            ...
            <Button onClick={google} variant="outline" className="w-full" disabled={busy}>
              <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
                <path
                  fill="#4285F4"
                  d="M22.5 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.75h3.57c2.08-1.92 3.28-4.74 3.28-8.07z"
                />
                <path
                  fill="#34A853"
